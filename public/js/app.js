...
function get_measurements() {
  ...
  $.get("/api/measurement", function (data, status) {
    ...
    if (status === 'success') {
      ...
      data = data[0]; // Formats a location string

      var location = "School: " + data.attributes.location.school + "<br>Rum: " + data.attributes.location.room; // Writes all info to DOM
